...
var BreakpointChild = fyne.NewMenu(
	"",
	fyne.NewMenuItem("Conditional Breakpoint", nil),
	fyne.NewMenuItem("Edit Breakpoint", nil),
	fyne.NewMenuItem("Inline Breakpoint", nil),
	fyne.NewMenuItem("Function Breakpoint", nil),
	fyne.NewMenuItem("Logpoint...", nil),
	fyne.NewMenuItem("Trigger Breakpoint", nil),
)
